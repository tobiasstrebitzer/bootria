...
(function() {
  ...
  jQuery(function() {
    var AlertView, DivView, DropdownDividerView, DropdownItemView, DropdownView, HeroView, Item, List, ListView, NavbarBrandView, NavbarDividerView, NavbarDropdownView, NavbarItemView, NavbarView, PackageView, RootView;
    ...
    NavbarView = (function(_super) {
      ...
      NavbarView.prototype.template = '<div class="navbar <%= style %>">' + '<div class="navbar-inner">' + '<div class="container">' + '<% if(responsive) { %>' + '<a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">' + '<span class="icon-bar"></span>' + '<span class="icon-bar"></span>' + '<span class="icon-bar"></span>' + '</a>' + '<% } %>' + '<ul class="nav"></ul>' + '</div>' + '</div>' + '</div>';
    ...
    NavbarDropdownView = (function(_super) {
      ...
      NavbarDropdownView.prototype.item = function(options) {
        options.parentView = this;
        options.el = this.el.find("ul.dropdown-menu");
      ...
      NavbarDropdownView.prototype.divider = function() {
        ...
        options = {
          parentView: this,
          el: this.el.find("ul.dropdown-menu")
        };
